...
--
-- Servidor: localhost
-- Tiempo de generación: 20-06-2014 a las 04:09:27
...
INSERT INTO `dedicacion` (`id`, `id_usuario`, `nombre_dedicacion`, `dedicacioncol`, `estado`) VALUES
(2, 0, 'sdfg', 'gsdfg', 'AC'),
(3, 0, 'sfdg', 'sdfg', 'AC'),
(4, 24, 'basket', 'play basketball', 'AC'),
(5, 0, 'soccer', 'soccer', 'AC'),
(6, 22, 'Voleyball', 'Voleyball', 'AC'),
(7, 22, 'Soccer', '', 'AC'),
(8, 22, 'natacion', '', 'AC'),
(11, 25, 'natacion', '', 'AC');
...
CREATE TABLE IF NOT EXISTS `dominio_idioma` (
  ...
  `dominio_idioma` varchar(45) DEFAULT NULL,
...
(19, 3, 1, 'regular', 'regular', 'bien', NULL, '', '', '0000-00-00', NULL),
(21, 1, 1, 'regular', 'bien', 'bien', NULL, '', '', '0000-00-00', NULL),
(22, 2, 1, 'regular', 'bien', 'bien', NULL, '', '', '0000-00-00', NULL),
(23, 1, 17, 'no', 'no', 'no', NULL, '', '', '0000-00-00', NULL),
(24, 2, 17, 'no', 'no', 'no', NULL, '', '', '0000-00-00', NULL),
(25, 3, 17, 'bien', 'bien', 'bien', NULL, '', '', '0000-00-00', NULL),
(26, 1, 22, 'bien', '', '', NULL, '', '', '0000-00-00', NULL),
(28, 2, 25, 'perfect', 'perfect', 'perfect', NULL, NULL, NULL, NULL, NULL),
(29, 3, 25, 'Intermedio', 'Intermedio', 'Intermedio', '', '', '', '0000-00-00', 'Pendiente'),
(33, 2, 25, 'Basico', 'Basico', 'Basico', '', '', '', '0000-00-00', 'Pendiente'),
(34, 1, 25, 'Avanzado', 'Avanzado', 'Avanzado', 'Avanzado', '', '', '0000-00-00', 'Pendiente'),
(35, 2, 25, 'Basico', 'Intermedio', 'Intermedio', 'Basico', '', '', '0000-00-00', 'Pendiente'),
(36, 1, 25, 'Basico', 'Basico', 'Basico', 'Intermedio', 'iiiiiiii', '', '0000-00-00', 'Pendiente');
...
(22, 'Arnold', 'Huanca', 'Valle', 222222, '', 0, '0000-00-00', 0, 'Extranjera', 'Femenino', '', 0, '', '', 'jahvtrek1@gmail.com', '', '', 0, 0, '', 0, 0, 0, 0, '', '', '', '0000-00-00', 22, '', 'AC'),
...
(6, 7, 22, '', 'Quillacollo', 'Barrio 12 de enero', 'Zona norte', 'calle 2 numero 93', 'Pendiente'),
(8, 7, 25, 'hhhhhhhhh', 'hhhhhhhh', 'hhhhhhhh', 'hhhhhhhhhh', 'hhhhhhhh', 'Pendiente');
