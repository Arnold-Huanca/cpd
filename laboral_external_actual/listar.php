...
$listado=  mysql_query("select * from laboral_external_actual");
?>
	...
	function EliminarDato(id)
  {
		...
		if ( msg )
    {
			$.ajax({
				url: 'eliminar.php',
				type: "GET",
				data: "laboral_external_actual_id="+id,
         ...
         <table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_lista_paises">
                ...
                <thead>
                    <tr>
                        ...
                        <th>Direccion</th><!--Estado-->
                        <th>Cargo</th>
                        <th>Fecha Inicio</th>
                        <th>Fecha Fin</th>
                        <th>Casilla Correo</th>
                        <th>Telefono</th>
                        <th>Fax</th>
                        <th>Email</th>
                        <th>VB</th>
                   ...
                   while($reg=  mysql_fetch_array($listado))
                     {
                               ...
                               echo '<td >'.mb_convert_encoding($reg['casilla_correo'], "UTF-8").'</td>';
                               echo '<td >'.mb_convert_encoding($reg['telefono'], "UTF-8").'</td>';
                               echo '<td >'.mb_convert_encoding($reg['fax'], "UTF-8").'</td>';
                               ...
                               echo '<td  ><a href=registro.php?editar=editando&laboral_external_actual_id='.mb_convert_encoding($reg['id'], "UTF-8").'>Editar</a><img src="../images/edit.png" title="Editar" alt="Editar" /></td>';
                               echo '<td><span class="dele"><a onClick="EliminarDato('.$reg['id'].'); return false" href="eliminar.php?laboral_external_actual_id='.$reg['id'].'"><center><img src="../images/delete.png" title="Eliminar" alt="Eliminar" /></center></a></span></td>';
						                   echo '</tr>';
