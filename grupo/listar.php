         ...
         <table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_lista_paises">
                ...
                <tfoot>
                 ...
                 define ("MODULO", "Grupo");
                  ...
                  $listado=  mysql_query("select g.* from  grupo g");
			  ...
			  <td><span class="modi"><a href="registro.php?grupo_id=<?php echo $resultado['id'] ?>"><img src="../images/edit.png" title="Editar" alt="Editar" /></a></span></td>
