   ...
   <div class="art-postcontent art-postcontent-0 clearfix">
      ...
      <form  class="contact_form"  id="contact_form"  action="#" method="post" id="registro" name="registro" >
             ...
             <p>
              <input type="text" name="institucion" id="institucion" value="{$membresia->institucion}" placeholder="Institucion"  size="22" >
              <label for="email"><small> Institucion</small></label>
            </p> 
            <p>
