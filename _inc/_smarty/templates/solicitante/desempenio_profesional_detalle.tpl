         ...
         <form  class="contact_form"  id="contact_form"  action="#" method="post" id="registro" name="registro" enctype="multipart/form-data">
            ...
            <p>
                 <label for="rol"><small>V.B.</small></label>
                    {if ($desemp_prof_externo->estado eq "Pendiente" || $desemp_prof_externo->estado eq "Aceptado" )}
           ...
           <p>
               ...
               <textarea name="observacion" id="observacion" > {$desemp_prof_externo->observacion}</textarea>
            </p>
              ...
              <input type="hidden" name="funcionario_id"  id="funcionario_id"  value="{$desemp_prof_externo->funcionario_id}">
