                   ...
                   while($reg=  mysql_fetch_array($listado))
                     {
                               ...
                               echo '<td >'.mb_convert_encoding($reg['fecha_resolucion'], "UTF-8").'</td>';
                               echo '<td >'.mb_convert_encoding($reg['materia_doc'], "UTF-8").'</td>';
                               echo '<td >'.mb_convert_encoding($reg['carrera_doc'], "UTF-8").'</td>';
