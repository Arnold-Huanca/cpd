<script type="text/javascript">
	...
	function EliminarDato(id)
  {
    ...
    {
			$.ajax({
				url: 'formacion_pregrado_eliminar.php',
				type: "GET",
				data: "id="+id,
 ...
 leerClase('Grado_academico');
			  ...
			  <td><?php echo $subarea->nombre_subarea ?></td>
			   ...
			   <td><span class="modi"><a href="formacion_pregrado_detalle.php?formacion_pregrado_id=<?php echo $resultado['id'] ?>"><img src="../images/edit.png" title="Editar" alt="Editar" /></a></span></td>
