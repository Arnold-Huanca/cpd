             ...
             <table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_lista_paises">
                ...
                <tfoot>
		          ...
		          <tr id="fila-<?php echo $resultado['id'] ?>">
                           ...
                           <td><span class="modi"><a href="plan_proyecto_programa_detalle.php?plan_proyecto_programa_id=<?php echo $resultado['id'] ?>"><img src="../images/edit.png" title="Editar" alt="Editar" /></a></span></td>
