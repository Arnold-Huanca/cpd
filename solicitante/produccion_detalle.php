...
$ERROR = ''; 
  ...
  $id     = '';
  $editar = FALSE;
  if ( isset($_GET['producion_id']) && is_numeric($_GET['producion_id']) )
  {
    $editar = TRUE;
    $id     = $_GET['producion_id'];
  }
 ...
 $circulacion_output[] = '- Seleccione -';
  ...
  $smarty->assign("tipo_producciones_output", $tipo_producciones_output);
   ...
   $funcionario= new Funcionario( $produccion->funcionario_id);
...
$TEMPLATE_TOSHOW = 'solicitante/produccion_detalle.tpl';
